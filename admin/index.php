<?php include ('../controls/connection.php');?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="utf-8">
  ...
  <link href="../css/toggle.css" rel="stylesheet"><!--Toggle switch-->
  ...
  <section id="topbar" class="d-none d-lg-block">
    <div class="container clearfix">
      <div class="contact-info float-left">
        <i class="fa fa-envelope-o"></i> <a href="mailto:contact@example.com">Halwa@gmail.com</a>
 ...
 <?php # include ('view/loginView.php');
	...
	?>
      <div id="logo" class="pull-left">
        <h1><a href="#body" class="scrollto">Admin</a></h1>
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li><a href="#services">Customer Details</a></li>
    ...
    <section id="services">
      <div class="container">
        <div class="section-header">
          ...
          <p>See the details of all the customer at one place.</p>
        </div>
       ...
       <!-- <div class="row">
          ...
          <div class="col-lg-6">
            <div class="box wow fadeInLeft">
              ...
              <h4 class="title"><a href="">Account Opening</a></h4>
  ...
  <script>
	...
	$(document).ready(function(e) {
        $("#admintable").load("view/admintable.php");
    });
